...
import org.eclipse.paho.android.sample.service.ActionListener.Action;
...
public class Listener implements OnMenuItemClickListener {
  ...
  private void createAndConnect()
  {
    ...
    //tommybee
    createConnection.setClassName(clientConnections.getApplicationContext(),MqttConts.ClassConsts.CLS_NewConnection);
