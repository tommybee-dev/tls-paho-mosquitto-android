    ...
    public boolean onMenuItemClick(MenuItem item) {
      {
        ...
        switch (id) {
          case R.id.connectAction :
            ...
            boolean tlscheck = ((CheckBox) findViewById(R.id.tlsSslCheckBox)).isChecked();
            //persist server
            ...
            dataBundle.putExtra(ActivityConstants.tlsssl, tlscheck);
          ...
          case R.id.advanced :
            ...
            dataBundle.setClassName(newConnection, MqttConts.ClassConsts.CLS_Advanced);
